   ...
   (function setCount(index){
       ...
       for(var i=0;i<index.length;i++){
           ...
           if(index[i][0]-1>=0){
               //上左
               if(index[i][1]-1>=0){
                   var zs=box.querySelector("ul:nth-of-type("+(index[i][0]+1-1)+") li:nth-of-type("+(index[i][1]+1-1)+")")
                   counts[i].push(zs);
               }
               //上中
               ...
               //上右
               if(index[i][1]+1<10){
                   var ys=box.querySelector("ul:nth-of-type("+(index[i][0]+1-1)+") li:nth-of-type("+(index[i][1]+1+1)+")")
                   counts[i].push(ys);
               }
           }
           //左
           ...
           if(index[i][0]+1<10){
               //下左
               if(index[i][1]-1>=0){
                   var zx=box.querySelector("ul:nth-of-type("+(index[i][0]+1+1)+") li:nth-of-type("+(index[i][1]+1-1)+")")
                   counts[i].push(zx);
               }
               //下中
               ...
               //下右
               if(index[i][1]+1<10){
                   var yx=box.querySelector("ul:nth-of-type("+(index[i][0]+1+1)+") li:nth-of-type("+(index[i][1]+1+1)+")")
                   counts[i].push(yx);
               }
           }
...
function sz(e){
   ...
   var f=e.parentNode;
   if(f.getAttribute("indexX")!="0"&&e.getAttribute("indexY")!="0"&&e.getAttribute("count")=="0"){
       var e=f.previousElementSibling.querySelector("li:nth-of-type("+parseInt(e.getAttribute("indexY"))+")");
...
function sy(e){
   ...
   e.className="current";
       e.setAttribute("flag",1)
   if(f.getAttribute("indexX")!="0"&&e.getAttribute("indexY")!="9"&&e.getAttribute("count")=="0"){
       var e=f.previousElementSibling.querySelector("li:nth-of-type("+(parseInt(e.getAttribute("indexY"))+2)+")");
...
function xy(e){
   ...
   e.className="current";
       e.setAttribute("flag",1)
   if(f.getAttribute("indexX")!="9"&&e.getAttribute("indexY")!="9"&&e.getAttribute("count")=="0"){
       var e=f.nextElementSibling.querySelector("li:nth-of-type("+(parseInt(e.getAttribute("indexY"))+2)+")");
...
function xz(e){
   ...
   e.className="current";
       e.setAttribute("flag",1)
   if(f.getAttribute("indexX")!="9"&&e.getAttribute("indexY")!="0"&&e.getAttribute("count")=="0"){
       var e=f.nextElementSibling.querySelector("li:nth-of-type("+(parseInt(e.getAttribute("indexY")))+")");
